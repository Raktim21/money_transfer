$(window).on("load", (function () {
    ...
    setTimeout((function () {
        ...
        colors: [a, a, window.colors.solid.primary, a, a, a],
        series: [{
            name: "Sessions",
