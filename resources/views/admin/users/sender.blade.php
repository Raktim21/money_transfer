...
@section('admin.sender.list', 'active')
...
<div class="row" id="table-contextual">
    <div class="col-12">
        <div class="card">
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalCenterTitle">Add new Sender</h5>
                            ...
                            <form action="{{ route('admin.user.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label for="avater">Sender Avater</label>
            ...
            <div class="card-body">
                <p class="card-text">
                   <form action="{{ route('admin.sender.list') }}" method="GET">
                        <div class="row">
                    ...
                    <tbody>
                        ...
                        @foreach ($users as $user)
                            <tr class="table-default">
                                ...
                                <td>
                                    <button class="btn btn-glow btn-info" data-toggle="modal" data-target="#recharge_modal{{ $user->id }}" >Recharge</button>
                                </td>
                                <td>
                                    <div class="dropdown">
                            ...
                            <div class="modal fade" id="recharge_modal{{ $user->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <form action="{{ route('admin.sender.recharge',$user->id) }}" method="POST" enctype="multipart/form-data" >
                                            @csrf
                                            <div class="modal-body">

                                                <div class="form-group">
                                                    <label for="fund">Amount (in Taka) <span class="text-danger">*</span></label>
                                                    <input required type="number" class="form-control" id="fund" name="fund" placeholder="100" value="0">
                                                </div>  
                            ...
                            <div class="modal fade" id="edit_modal{{ $user->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">Update Sender</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
