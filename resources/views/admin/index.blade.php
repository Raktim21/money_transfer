            ...
            <div class="col-xl-4 col-md-6 col-12">
                <div class="card card-congratulation-medal">
                    <div class="card-body">
                        ...
                        <img src="{{ asset('dashboard_assets/app-assets/images/illustration/badge.sv') }}g"
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar rounded">
                                                    <div class="avatar-content">
                                                        <img src="{{ asset('dashboard_assets/app-assets/images/icons/toolbox.sv') }}g"
                                                            alt="Toolbar svg" />
                                                    </div>
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar rounded">
                                                    <div class="avatar-content">
                                                        <img src="{{ asset('dashboard_assets/app-assets/images/icons/parachute.sv') }}g"
                                                            alt="Parachute svg" />
                                                    </div>
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar rounded">
                                                    <div class="avatar-content">
                                                        <img src="{{ asset('dashboard_assets/app-assets/images/icons/brush.sv') }}g"
                                                            alt="Brush svg" />
                                                    </div>
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar rounded">
                                                    <div class="avatar-content">
                                                        <img src="{{ asset('dashboard_assets/app-assets/images/icons/star.sv') }}g"
                                                            alt="Star svg" />
                                                    </div>
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar rounded">
                                                    <div class="avatar-content">
                                                        <img src="{{ asset('dashboard_assets/app-assets/images/icons/book.sv') }}g"
                                                            alt="Book svg" />
                                                    </div>
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar rounded">
                                                    <div class="avatar-content">
                                                        <img src="{{ asset('dashboard_assets/app-assets/images/icons/rocket.sv') }}g"
                                                            alt="Rocket svg" />
                                                    </div>
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar rounded">
                                                    <div class="avatar-content">
                                                        <img src="{{ asset('dashboard_assets/app-assets/images/icons/speaker.sv') }}g"
                                                            alt="Speaker svg" />
                                                    </div>
                                                </div>
                                                <div>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="card card-developer-meetup">
                    <div class="meetup-img-wrapper rounded-top text-center">
                        <img src="{{ asset('dashboard_assets/app-assets/images/illustration/email.svg" alt="Meeting Pi') }}c"
                            height="170" />
                    </div>
                    <div class="card-body">
                        ...
                        <div class="avatar-group">
                            <div data-toggle="tooltip" data-popup="tooltip-custom"
                                ...
                                <img src="{{ asset('dashboard_assets/app-assets/images/portrait/small/avatar-s-9.jp') }}g"
                                    alt="Avatar" width="33" height="33" />
                            </div>
                            <div data-toggle="tooltip" data-popup="tooltip-custom"
                                data-placement="bottom" data-original-title="Amy Carson"
                                class="avatar pull-up">
                                <img src="{{ asset('dashboard_assets/app-assets/images/portrait/small/avatar-s-6.jp') }}g"
                                    alt="Avatar" width="33" height="33" />
                            </div>
                            <div data-toggle="tooltip" data-popup="tooltip-custom"
                                data-placement="bottom" data-original-title="Brandon Miles"
                                class="avatar pull-up">
                                <img src="{{ asset('dashboard_assets/app-assets/images/portrait/small/avatar-s-8.jp') }}g"
                                    alt="Avatar" width="33" height="33" />
                            </div>
                            <div data-toggle="tooltip" data-popup="tooltip-custom"
                                data-placement="bottom" data-original-title="Daisy Weber"
                                class="avatar pull-up">
                                <img src="{{ asset('dashboard_assets/app-assets/images/portrait/small/avatar-s-20.jp') }}g"
                                    alt="Avatar" width="33" height="33" />
                            </div>
                            <div data-toggle="tooltip" data-popup="tooltip-custom"
                ...
                <div class="card card-browser-states">
                    ...
                    <div class="card-body">
                        <div class="browser-states">
                            <div class="media">
                                <img src="{{ asset('dashboard_assets/app-assets/images/icons/google-chrome.pn') }}g"
                        ...
                        <div class="browser-states">
                            <div class="media">
                                <img src="{{ asset('dashboard_assets/app-assets/images/icons/mozila-firefox.pn') }}g"
                        ...
                        <div class="browser-states">
                            <div class="media">
                                <img src="{{ asset('dashboard_assets/app-assets/images/icons/apple-safari.pn') }}g"
                        ...
                        <div class="browser-states">
                            <div class="media">
                                <img src="{{ asset('dashboard_assets/app-assets/images/icons/internet-explorer.pn') }}g"
                        ...
                        <div class="browser-states">
                            <div class="media">
                                <img src="{{ asset('dashboard_assets/app-assets/images/icons/opera.png" class="rounded mr-') }}1"
